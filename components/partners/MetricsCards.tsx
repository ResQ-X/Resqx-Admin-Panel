    ...
    <div className="grid grid-cols-4 gap-4">
      <Card className="bg-white p-4 rounded-lg">
        ...
        <div className="flex items-center gap-1 mt-4">
          ...
          <span className="text-green-500 text-sm">
            {metrics.activePartners.change}
          </span>
          <span className="text-gray-500 text-sm">
            {metrics.activePartners.timeframe}
          </span>
        </div>
      </Card>
      ...
      <Card className="p-4">
        ...
        <div className="flex items-center gap-1 mt-4">
          ...
          <span className="text-gray-500 text-sm">
            {metrics.avgResponseTime.timeframe}
          </span>
        </div>
      </Card>
      ...
      <Card className="p-4">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-2xl font-semibold mt-1">
              {metrics.customerSatisfaction.value}
            </p>
          </div>
        ...
        <div className="flex items-center gap-1 mt-4">
          ...
          <span className="text-gray-500 text-sm">
            {metrics.customerSatisfaction.timeframe}
          </span>
        </div>
      </Card>
