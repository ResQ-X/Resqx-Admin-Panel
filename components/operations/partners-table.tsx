...
export function PartnersTable({ partners }: PartnersTableProps) {
  ...
  const filteredPartners = selectedTab === "All" ? partners : partners.filter((p) => p.status === selectedTab)
            ...
            <TableRow key={partner.id}>
              ...
              <TableCell>
                <div className="text-sm">
                  <p>Avg. Response Time: {partner.performanceMetrics.avgResponseTime}</p>
                  <p>Incidents Resolved: {partner.performanceMetrics.incidentsResolved}</p>
                </div>
              </TableCell>
              <TableCell>
                <DropdownMenu>
