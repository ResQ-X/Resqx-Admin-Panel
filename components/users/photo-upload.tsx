      ...
      <div className="relative cursor-pointer group" onClick={() => setIsOpen(true)}>
        {currentPhoto ? (
          <div className="h-24 w-24 rounded-full overflow-hidden">
            <img src={currentPhoto || "/placeholder.svg"} alt="Profile" className="h-full w-full object-cover" />
          </div>
        ) : (
        ...
        <DialogContent>
          ...
          {uploadState.status === "uploading" ? (
            <div className="py-8">
              ...
              <p className="text-center text-sm text-gray-500">Uploading photo...</p>
            </div>
            ...
            <div className="py-8 flex flex-col items-center">
              ...
              <p className="text-lg font-semibold">Photo uploaded successfully!</p>
            </div>
          ) : ( 
            <div className="py-8">
              <div
              ...
              >
                ...
                <p className="text-sm text-gray-500">Click to upload a photo or drag and drop</p>
              </div>
